...
Implementation target; not yet implemented. Targets the [v0.0.2 milestone](https://github.com/raeperd/pidex/milestone/2) and builds on the completed [v0.0.1 baseline](v0.0.1-tech-spec.md). Keep milestones on `0.0.x` until Pidex is usable for daily work. Terms follow the [Pidex glossary](glossary.md).
