...
This guide is based on retry patterns and `ExecutionPlan` usage in the shared explorer Effect repo.

Key source files:

- `$EFFECT_REPO/packages/effect/src/Effect.ts`
- `$EFFECT_REPO/packages/effect/src/Schedule.ts`
- `$EFFECT_REPO/packages/effect/src/ExecutionPlan.ts`
- `$EFFECT_REPO/packages/effect/test/Effect.test.ts`
- `$EFFECT_REPO/packages/effect/test/ExecutionPlan.test.ts`

Representative repo usage:

- `$EFFECT_REPO/packages/effect/src/unstable/workflow/Activity.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/workflow/WorkflowEngine.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/rpc/RpcClient.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/observability/OtlpExporter.ts`
- `$EFFECT_REPO/packages/vitest/src/internal/internal.ts`
...
The shared explorer tests show several important supported forms.
...
The shared explorer repo repeatedly uses these patterns:
...
The shared explorer tests focus on `Stream.withExecutionPlan` and demonstrate:
