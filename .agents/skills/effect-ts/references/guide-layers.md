...
- `$EFFECT_REPO/packages/effect/src/Context.ts`
- `$EFFECT_REPO/packages/effect/src/Layer.ts`
- `$EFFECT_REPO/packages/effect/src/Effect.ts`
- `$EFFECT_REPO/packages/effect/src/ManagedRuntime.ts`
...
This matches the shared explorer repo's current style.
...
- it matches the patterns used across the shared Effect explorer checkout
...
- `$EFFECT_REPO/packages/effect/src/Layer.ts`
- `$EFFECT_REPO/packages/effect/src/ManagedRuntime.ts`
- `$EFFECT_REPO/packages/effect/src/Stream.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/sql/SqlClient.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/persistence/Persistence.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/rpc/RpcSerialization.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/reactivity/Reactivity.ts`
