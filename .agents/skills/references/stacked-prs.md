...
3. Propagate and verify changes.
   ...
   - After prerequisite changes, rerun affected layers' checks. Return changed ready PRs to draft and resume their pidex-review-pr checks before restoring readiness. Preserve review records so rebases cannot duplicate a Codex trigger within the run.
