...
4. Verify and publish each layer as a draft.
   ...
   - Follow the shared [PR description format](../references/pr-descriptions.md) when creating or updating the body. Keep the review fixed point in the run record for the review phase.
