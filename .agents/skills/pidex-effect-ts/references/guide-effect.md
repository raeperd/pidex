...
This guide is based on common usage patterns in the shared explorer repo at `$EFFECT_REPO`.

Key source areas:

- `$EFFECT_REPO/packages/effect/src/Effect.ts`
- `$EFFECT_REPO/packages/tools/`
- `$EFFECT_REPO/packages/platform-*`
- `$EFFECT_REPO/packages/opentelemetry/`
- `$EFFECT_REPO/packages/vitest/`
...
- `$EFFECT_REPO/packages/tools/utils/src/Codegen.ts`
- `$EFFECT_REPO/packages/tools/openapi-generator/src/OpenApiPatch.ts`
...
- `$EFFECT_REPO/packages/tools/openapi-generator/src/OpenApiGenerator.ts`
...
- `$EFFECT_REPO/packages/tools/utils/src/bin.ts`
- `$EFFECT_REPO/packages/tools/openapi-generator/test/`
...
- `$EFFECT_REPO/packages/platform-node/`
- `$EFFECT_REPO/packages/opentelemetry/src/NodeSdk.ts`
...
- `$EFFECT_REPO/packages/platform-node/`
- `$EFFECT_REPO/packages/vitest/src/index.ts`
