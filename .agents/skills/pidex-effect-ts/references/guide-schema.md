...
This guide is based on the shared explorer Schema module and common repo usage in `$EFFECT_REPO`.

Key source files:

- `$EFFECT_REPO/packages/effect/src/Schema.ts`
- `$EFFECT_REPO/packages/effect/src/SchemaTransformation.ts`
- `$EFFECT_REPO/packages/effect/src/SchemaGetter.ts`
- `$EFFECT_REPO/packages/effect/src/SchemaIssue.ts`
- `$EFFECT_REPO/packages/effect/src/JsonSchema.ts`

Representative repo usage:

- `$EFFECT_REPO/packages/tools/ai-codegen/src/Config.ts`
- `$EFFECT_REPO/packages/platform-node/test/fixtures/rpc-schemas.ts`
- `$EFFECT_REPO/packages/platform-browser/test/IndexedDbQueryBuilder.test.ts`
- `$EFFECT_REPO/packages/tools/openapi-generator/`
...
Important rule from the shared explorer docs:
...
The shared explorer docs explicitly note that `decodeTo` is curried and should be used with `pipe`.
...
The shared explorer `Schema.ts` implements key renaming by mapping fields and using decode/encode transformations with renamed key maps.
...
Patterns visible in the shared explorer repo:
...
- `$EFFECT_REPO/packages/platform-node/test/fixtures/rpc-schemas.ts`
- `$EFFECT_REPO/packages/platform-browser/test/IndexedDbQueryBuilder.test.ts`
- `$EFFECT_REPO/packages/tools/openapi-generator/src/JsonSchemaGenerator.ts`
- `$EFFECT_REPO/packages/effect/src/Schema.ts`
