...
- `$EFFECT_REPO/packages/effect/src/Data.ts`
- `$EFFECT_REPO/packages/effect/src/Schema.ts`
- `$EFFECT_REPO/packages/effect/src/Cause.ts`
- `$EFFECT_REPO/packages/effect/src/Effect.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/sql/SqlError.ts`
...
- `$EFFECT_REPO/packages/effect/src/Schema.ts`
- examples across `$EFFECT_REPO/packages/effect/src/unstable/*`

Example shape from the shared explorer repo:

- `$EFFECT_REPO/packages/effect/src/unstable/httpapi/HttpApiError.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/workers/WorkerError.ts`
...
The shared explorer repo uses schema-backed errors in places like SQL, RPC, sockets, and HTTP APIs.

Strong examples:

- `$EFFECT_REPO/packages/effect/src/unstable/sql/SqlError.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/socket/Socket.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/eventlog/EventLogMessage.ts`
...
This is a very common pattern in the shared explorer repo.

Good examples:

- `$EFFECT_REPO/packages/effect/src/unstable/sql/SqlError.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/rpc/RpcClientError.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/socket/Socket.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/workers/WorkerError.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/persistence/Redis.ts`
...
- `$EFFECT_REPO/packages/effect/src/Schema.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/sql/SqlError.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/http/HttpClientError.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/http/HttpServerError.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/socket/Socket.ts`
- `$EFFECT_REPO/packages/effect/src/unstable/httpapi/HttpApiError.ts`
