    ...
    {#if commandSuggestions.length > 0}
      ...
      >
        {#each commandSuggestions as command (command.name)}
          ...
          >
            <span class="w-30 flex-none font-mono text-xs font-medium text-primary-text"
              >/{command.name}</span
            >
